    ...
    $('tbody').tableDnD({
        onDrop: function (table, row) {
            $('tbody tr.todolistitem').each(function (order_index) {
                ...
                if (orderid != order_index) {
                    app.changeOrderId(taskid, order_index);
                    $(this).attr('data-orderid',order_index);
                }
                // app.getAllTasks();
            });
...
var app = new Vue({
    ...
    methods: {
        clearMessages: function () {
            ...
            axios.get("https://rg.usejs.top/api.php?action=idautorizeduser").then(function (response) {
            ...
            axios.post("https://rg.usejs.top/api.php?action=signupuser", formData).then(function (response) {
            ...
            axios.post("https://rg.usejs.top/api.php?action=signinuser", formData).then(function (response) {
                app.newUser = {login: "", password: ""};
                if (response.data.error) {
                    app.errorMessage = response.data.message;
                } else {
            ...
            var formData = app.toFormData(app.user);
            axios.post("https://rg.usejs.top/api.php?action=signoutuser", formData).then(function (response) {
                if (response.data.error) {
                    app.errorMessage = response.data.message;
                } else {
                    app.successMessage = response.data.message;
            ...
            axios.get("https://rg.usejs.top/api.php?action=readtodos").then(function (response) {
                if (response.data.error) {
                    app.errorMessage = response.data.message;
                } else {
                    app.clearMessages();
            ...
            axios.get("https://rg.usejs.top/api.php?action=readtasks").then(function (response) {
                if (response.data.error) {
                    app.errorMessage = response.data.message;
                } else {
                    var arr = [];
                    ...
                    for (var index in obj) {
                        ...
                        var taskid = obj[index].id,
                            orderid;

                        orderid = index;
                        if (orderid != index) {
                            console.log('orderid ,index', orderid ,index);
                            app.changeOrderId(taskid, orderid);
                        }


                        // if (!obj[index].order_id || obj[index].order_id != index) {
                        //     var taskid = obj[index].id,
                        //         orderid;
                        //     console.log('orderid ,index', orderid ,index);
                        //     orderid = index;
            ...
            axios.post("https://rg.usejs.top/api.php?action=createtodo", formData).then(function (response) {
            ...
            axios.post("https://rg.usejs.top/api.php?action=createtask", formData).then(function (response) {
            ...
            var formData = app.toFormData(app.thisTodo);
            axios.post("https://rg.usejs.top/api.php?action=updatetodo", formData).then(function (response) {
            ...
            axios.post("https://rg.usejs.top/api.php?action=updatetask", formData).then(function (response) {
        ...
        }, completedTask: function (taskid, status) {
            axios.get("https://rg.usejs.top/api.php?action=completedtask", {
                params: {
                    taskid: taskid,
                    iscomplete: status
                }
            ...
            axios.post("https://rg.usejs.top/api.php?action=deletetodo", formData).then(function (response) {
                app.clickedTodo = {};
                if (response.data.error) {
                    app.errorMessage = response.data.message;
                } else {
            ...
            axios.post("https://rg.usejs.top/api.php?action=deletetask", formData).then(function (response) {
                app.clickedTask = {};
                if (response.data.error) {
                    app.errorMessage = response.data.message;
                } else {
